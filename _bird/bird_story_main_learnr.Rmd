...
#Scatterplot with rich and ha (habitat area)
...
#Question 1
#What is a transformation that could be done to the x-axis to
#create an easier graph to interpret?
...
#Question 2
#Create a scatterplot with rich and log(ha)
scatterplot(rich ~ ha, data=statcat_datadog_df,
            smooth=F)
...
#We see a strong, positive linear relationship between log(Ha) and species richness. 
