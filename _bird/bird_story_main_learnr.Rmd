...
cat_species_df <- read.csv('..data/cat_species.csv')
...
setwd("C:/Users/cbolc/Desktop/_bird")
statcat_rich_df <- read.csv('..data/statcat_rich.csv')
datadog_ha_df <- read.csv('..data/datadog_ha.csv')
...
statcat_rich_df <- read.csv('..data/statcat_rich.csv')
datadog_ha_df <- read.csv('..data/datadog_ha.csv')
statcat_datadog_df <- merge(stastatcat_rich_df, datadog_rich_df, by = "site")
